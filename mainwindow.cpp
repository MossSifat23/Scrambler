...
#include "build/Desktop_Qt_6_9_2_MinGW_64_bit-Debug/chris_code_for_wordle_autogen/include/ui_mainwindow.h"
#include<QLabel>
...
{
    ui->stackedWidget->setCurrentIndex(0); //(Yes) To Game Start Page
